...
void DEVICE_DETAILS_TO_CLOUD(void);
void STATUS_TO_CLOUD(void);
...
/*|---------------------------------------------------------------------------------------|
    Credential Assigning for Wifi Connectivity at Global Variables  [NOT OPERATING]
  |---------------------------------------------------------------------------------------|*/
...
/*|------------------------------------------------------------------------------------|
     HandleClient(); Function have HTML page and storing Inputs from that in EEP ROM  [NOT OPERATING]
  |------------------------------------------------------------------------------------|*/
...
/*|---------------------------------------------------------------------------------------|
                   Config_Mode - Program Goes in to This On Interupt [NOT OPERATING]
  |---------------------------------------------------------------------------------------|*/
...
void DATA_TO_CLOUD() {
  Serial.println(F(" "));
  Serial.println(F(" ---> FUNCTION : 2_DATA_TO_CLOUD "));
