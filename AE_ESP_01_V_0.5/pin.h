...
int ERR_CODE = 0;   // 0 = ALL OK | 1 = SENSOR DATA ERROR | 2 = SENSOR TIMEOUT | 3 = SD CARD FAILED | 4 = RTC ERROR |
...
// Define variables for motor mode timing
unsigned long motorModeOnTime = 0;
unsigned long motorModeOffTime = 0;
const unsigned long motorModeDuration = 10000; // 20 seconds

unsigned long motorModeCooldownEnd = 0;
const unsigned long motorModeCooldownDuration = 20000; // 1 minute cooldown period
...
int SM_1_1 = 23;  // (12V) SM1-1: ON - 1 || OFF - 0  [SWITCH:T1 - (1) Motor Mode & (0) Gen Mode]
int SM_1_2 = 22;  // (12V) SM1-2: ON - 1 || OFF - 0  [SWITCH:T1 - (1) Power to Batt. Mode & (0) Dump Power Mode]
int SM_2_1 = 21;  // (12V) SM2-1: ON - 1 || OFF - 0  [SWITCH:T2 - (1) Motor Mode & (0) Gen Mode]
int SM_2_2 = 19;  // (12V) SM2-2: ON - 1 || OFF - 0  [SWITCH:T2 - (1) Power to Batt. Mode & (0) Dump Power Mode]
int SM_3_1 = 18;  // (12V) SM3-1: ON - 1 || OFF - 0  [SWITCH:T3 - (1) Motor Mode & (0) Gen Mode]
int SM_3_2 = 5;   // (12V) SM3-2: ON - 1 || OFF - 0  [SWITCH:T3 - (1) Power to Batt. Mode & (0) Dump Power Mode]

int STSM_1_1, STSM_1_2, STSM_2_1, STSM_2_2, STSM_3_1, STSM_3_2;
...
const int RPM_T1_Pin = 25;     // [High/Low Pulse input Interrupt]
const int RPM_T2_Pin = 33;     // [High/Low Pulse input Interrupt]
const int RPM_T3_Pin = 32;     // [High/Low Pulse input Interrupt]

const int Wind_Speed_Pin = 34; // [Analog Value: 0V - 3V]
...
float Wind_Speed;    // Variable to store wind speed reading
